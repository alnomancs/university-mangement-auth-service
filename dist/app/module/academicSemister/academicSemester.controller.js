...
const getSemesters = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = (0, pick_1.default)(
      req.query,
      academicSemester_constrant_1.academicSemesterFilterableField
    );
    ...
    const result =
      yield academicSemester_services_1.AcademicSemesterService.getSemesters(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
