...
const moduleRoutes = [
    ...
    { path: "/academic-semester", route: academicSemester_router_1.AcademicSemesterRouter },
    { path: "/academic-faculty", route: academicFaculty_router_1.AcademicFacultyRouter },
    { path: "/academic-department", route: academicDepartment_router_1.AcademicDepartmentRouter },
    { path: "/management-departments", route: managementDepartment_router_1.ManagementDepartmentRouter }, //academic faculty routes
];
